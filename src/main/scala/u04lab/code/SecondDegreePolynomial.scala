...
@main def checkComplex(): Unit =
  ...
  println(SecondDegreePolynomialImpl(1.0, 0, 3).toString);
  println(SecondDegreePolynomialImpl(1.0, 0, 3) == SecondDegreePolynomialImpl(1.0, 0, 3))
